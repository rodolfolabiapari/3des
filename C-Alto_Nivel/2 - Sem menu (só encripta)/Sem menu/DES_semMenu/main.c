...
void chave(char C[16][28], char D[16][28], char CD[15][56], char K[15][48], FILE * arq) {
	...
	if((entrada = fopen("senha.txt", "r")) == NULL) {
...
int main (int argc, char *argv[]) {
	...
	*/
	...
	char key_PC1[56], C[16][28], D[16][28], CD[15][56], K[15][48]; FILE * arq;
