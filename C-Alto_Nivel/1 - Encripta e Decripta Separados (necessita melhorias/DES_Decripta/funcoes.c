...
void des_round(FILE * arquivo, char * L1, char * R1, char * L0, char * R0, char * ER0, char * K1, char * F1) {
    char t[3], tp[5], f[32];
    ...
    permut_48(R0, ER0);
    printf("Permutação 48. R0 to ER0: ");
    fprintf(arquivo, "\nPermutação 48. R0 to ER0: ");
    for (i = 0; i < 48; i++) {
        printf("%c", ER0[i]);
